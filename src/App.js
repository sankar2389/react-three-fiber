...
import { useGLTF, useTexture, Center, ContactShadows, Environment, OrbitControls } from '@react-three/drei'

function Vehicle(props) {
  const { scene } = useGLTF('https://market-assets.fra1.cdn.digitaloceanspaces.com/market-assets/models/ambulance/model.gltf')
...
function Tree(props) {
  const { scene } = useGLTF('https://market-assets.fra1.cdn.digitaloceanspaces.com/market-assets/models/low-poly-tree/model.gltf')
  return <primitive object={scene} {...props} />
}
...
function Heli(props) {
  ...
  const textures = useTexture({
    metalnessMap: 'https://market-assets.fra1.cdn.digitaloceanspaces.com/market-assets/materials/gold/Metal007_1K_Metalness.jpg',
    map: 'https://market-assets.fra1.cdn.digitaloceanspaces.com/market-assets/materials/gold/Metal007_1K_Color.jpg',
    normalMap: 'https://market-assets.fra1.cdn.digitaloceanspaces.com/market-assets/materials/gold/Metal007_1K_Normal.jpg',
    roughnessMap: 'https://market-assets.fra1.cdn.digitaloceanspaces.com/market-assets/materials/gold/Metal007_1K_Roughness.jpg'
  })
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      <mesh ref={fin} geometry={nodes.TopFin.geometry} material={nodes.TopFin.material} position={[0.29, 2.34, -0.35]} rotation={[Math.PI, -0.53, Math.PI]} />
    </group>
  )
}
...
export default function App() {
  return (
    <Canvas dpr={[1, 2]} camera={{ position: [0, 2, 8] }}>
      ...
      <Suspense fallback={null}>
        ...
        <ContactShadows rotation-x={Math.PI / 2} opacity={0.5} width={10} height={10} blur={2} far={4} />
